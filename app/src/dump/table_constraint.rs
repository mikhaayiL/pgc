...
impl TableConstraint {
    ...
    /// returns the normalized column name. Quoted identifiers preserve their
    /// original case; unquoted identifiers are lowercased to match PostgreSQL
    /// identifier folding. Otherwise returns `None`.
    ///
